  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          <div className="col-span-2 sm:col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-3 sm:mb-4">
              <img src="./logo2.svg" alt="Logo" className="h-8 w-8 sm:h-10 sm:w-10" />
          ...
          <div>
            <h3 className="font-semibold mb-2 sm:mb-3 text-sm sm:text-base">Product</h3>
            <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm" style={{ color: 'rgba(255, 255, 255, 0.60)' }}>
        ...
        >
          <p className="text-xs sm:text-sm text-center sm:text-left" style={{ color: 'rgba(255, 255, 255, 0.38)' }}>
