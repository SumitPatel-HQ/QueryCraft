...
export function UseCasesSection() {
  return (
    <section id="use-cases" className="mt-4 sm:mt-6 px-4 bg-[#0D0D0D]/30 overflow-hidden">
      <div className="max-w-7xl mx-auto mb-8 sm:mb-12">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-3 sm:mb-4 bg-gradient-to-r from-white via-white/90 to-white/70 bg-clip-text text-transparent px-4">
            <TextType
          ...
          <ScrollCarouselItem key={index}>
            ...
            */}
            <div className="p-6 sm:p-8 h-full flex flex-col group">
              ...
              <div className="absolute -bottom-8 -right-8 sm:-bottom-10 sm:-right-10 w-32 h-32 sm:w-40 sm:h-40 bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-full blur-3xl pointer-events-none group-hover:from-purple-500/20 group-hover:to-pink-500/20 transition-all duration-500" />
            </div>
          </ScrollCarouselItem>
        ))}
      </ScrollCarousel>
