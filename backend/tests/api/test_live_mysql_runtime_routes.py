...
def test_mysql_query_route_returns_query_items_for_compound_request(monkeypatch):
    _install_firebase_stubs()
            ...
            return {
                ...
                "query_items": [
                    ...
                    },
                    {
                        ...
                        "sql_query": "SELECT table_name, column_name, referenced_table FROM information_schema.key_column_usage",
