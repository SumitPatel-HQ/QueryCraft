...
class LLMSQLGenerator:
    ...
    def __init__(self, model_name: Optional[str] = None, timeout: Optional[int] = None):
        ...
        self.client = GeminiClient(model_name, timeout)
    ...
    def generate_sql_with_llm(
        ...
        try:
            ...
            logger.info(f"✅ SQL generated successfully. Confidence: {confidence_score:.2f}")
    ...
    def generate_query_explanation(
        ...
        try:
            ...
            if not response["success"]:
                ...
                fallback = self.prompts.get_fallback_explanation(
                    sql_query,
                    tables_used
                )
                return {
